...
plt.subplot(232)
plt.imshow(dst_robert, cmap='gray', vmin='0', vmax='255')
plt.title("Dst Robert")
plt.xticks([0]), plt.yticks([0])
plt.subplot(233)
plt.imshow(dst_prewitt, cmap='gray', vmin='0', vmax='255')
plt.title("Dst Prewitt")
plt.xticks([0]), plt.yticks([0])
plt.subplot(234)
plt.imshow(dst_sobel, cmap='gray', vmin='0', vmax='255')
plt.title("Dst Sobel")
plt.xticks([0]), plt.yticks([0])
plt.subplot(235)
plt.imshow(dst_laplacian, cmap='gray', vmin='0', vmax='255')
plt.title("Dst Laplacian")
plt.xticks([0]), plt.yticks([0])
